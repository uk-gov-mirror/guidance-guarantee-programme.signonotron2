class EventLog < ActiveRecord::Base
  ...
  EVENTS = [
    ACCOUNT_LOCKED                            = LogEntry.new(id: 1,
                                                             description: "Passphrase verification failed too many times, account locked for #{LOCKED_DURATION}"), # rubocop:disable Layout/LineLength
    ACCOUNT_SUSPENDED                         = LogEntry.new(id: 2, description: "Account suspended",
                                                             require_initiator: true),
    ACCOUNT_UNSUSPENDED                       = LogEntry.new(id: 3, description: "Account unsuspended",
                                                             require_initiator: true),
    ACCOUNT_AUTOSUSPENDED                     = LogEntry.new(id: 4, description: "Account auto-suspended"),
    MANUAL_ACCOUNT_UNLOCK                     = LogEntry.new(id: 5, description: "Manual account unlock",
                                                             require_initiator: true),
    ...
    SUSPENDED_ACCOUNT_AUTHENTICATED_LOGIN     = LogEntry.new(id: 13,
                                                             description: "Unsuccessful login attempt to a suspended account, with the correct username and password"), # rubocop:disable Layout/LineLength
    UNSUCCESSFUL_PASSPHRASE_CHANGE            = LogEntry.new(id: 14, description: "Unsuccessful passphrase change"),
    EMAIL_CHANGED                             = LogEntry.new(id: 15, description: "Email changed",
                                                             require_initiator: true),
    ...
    TWO_STEP_LOCKED                           = LogEntry.new(id: 23,
                                                             description: "2-step verification failed too many times, account locked for #{LOCKED_DURATION}"), # rubocop:disable Layout/LineLength
    TWO_STEP_CHANGED                          = LogEntry.new(id: 24, description: "2-step verification phone changed"),
    TWO_STEP_CHANGE_FAILED                    = LogEntry.new(id: 25,
                                                             description: "2-step verification phone change failed"),
    TWO_STEP_PROMPT_DEFERRED                  = LogEntry.new(id: 26, description: "2-step prompt deferred"),
    API_USER_CREATED                          = LogEntry.new(id: 27, description: "Account created",
                                                             require_initiator: true),
    ACCESS_TOKEN_REGENERATED                  = LogEntry.new(id: 28, description: "Access token re-generated",
                                                             require_application: true),
    ACCESS_TOKEN_GENERATED                    = LogEntry.new(id: 29, description: "Access token generated",
                                                             require_application: true, require_initiator: true),
    ACCESS_TOKEN_REVOKED                      = LogEntry.new(id: 30, description: "Access token revoked",
                                                             require_application: true, require_initiator: true),
    PASSPHRASE_RESET_LOADED_BUT_TOKEN_EXPIRED = LogEntry.new(id: 31,
