    ...
    context "changing an email" do
      should "stage the change, send a confirmation email to the new address and email change notification to the old address" do
        perform_enqueued_jobs do
          ...
          assert_equal "Your Pension Wise Signon development email address is being changed", email_changed_notification.subject
      ...
      context "changing an email" do
        ...
        should "send email change notifications to old and new email address" do
          perform_enqueued_jobs do
            ...
            assert_equal ['Your Pension Wise Signon development email address has been updated'], email_change_notifications.map(&:subject).uniq
