    ...
    context "for an active user" do
      should "send a notification email and not confirmation email" do
        perform_enqueued_jobs do
          ...
          assert_equal 'Your Pension Wise Signon development email address has been updated', last_email.subject
        end
      end
  ...
  context "by a user themselves" do
    ...
    should "trigger a confirmation email to the user's new address and a notification to the user's old address" do
      perform_enqueued_jobs do
        ...
        assert_equal 'Your Pension Wise Signon development email address is being changed', notification_email.subject
      end
    end
