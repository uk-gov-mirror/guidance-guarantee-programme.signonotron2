...
class PassphraseResetTest < ActionDispatch::IntegrationTest
  ...
  BLANKET_RESET_MESSAGE = "If your email address is recognised, you’ll receive an email with instructions about how to reset your passphrase." # rubocop:disable Layout/LineLength
